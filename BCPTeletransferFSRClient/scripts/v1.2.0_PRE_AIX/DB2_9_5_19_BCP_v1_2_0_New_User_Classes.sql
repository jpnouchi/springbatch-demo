...
BEGIN
	...
	INSERT INTO SPFB_USER_CLASSES(ID_USER_CLASS, USER_CLASS_CODE, DESCRIPTION, CLASS_TYPE, ID_STORAGE_CLASS, EXPIRY_AFTER_PUT, EXPIRY_AFTER_READ, DELETE_MODE, ARCHIVING_OPT, CREATION_DATE, UPDATE_DATE) VALUES (userClassId, 'BCPTTADMIN', 'BCP Teletransfer Administrator User class', 0, storageClassId, 0, 0, 0, 0, null, null); 
	
	------------------------------------------------------------------------
	-- BCP Teletransfer Administrator Audit User class
	------------------------------------------------------------------------
	CALL INCREMENT_COUNTER(8, userClassId);
	INSERT INTO SPFB_USER_CLASSES(ID_USER_CLASS, USER_CLASS_CODE, DESCRIPTION, CLASS_TYPE, ID_STORAGE_CLASS, EXPIRY_AFTER_PUT, EXPIRY_AFTER_READ, DELETE_MODE, ARCHIVING_OPT, CREATION_DATE, UPDATE_DATE) VALUES (userClassId, 'BCPTTADMIN_AUDIT', 'BCP Teletransfer Administrator Audit User class', 0, storageClassId, 15120000, 0, 0, 0, null, null); 
